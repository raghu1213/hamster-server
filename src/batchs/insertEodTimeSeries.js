...
for (let symbol of tickersToFetch) {
    ...
    let adj_openIdx = header.indexOf("adj_Open");
    let adj_highIdx = header.indexOf("adh_High");
    let adj_lowIdx = header.indexOf("adj_Low");
    let adj_closeIdx = header.indexOf("adj_Close");
    let adj_volumeIdx = header.indexOf("adj_Volume");
    let refDate = new Date(2016, 1, 1);
